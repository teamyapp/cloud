...
const (
	Generator_GenerateUniqueNumber_FullMethodName = "/Generator/GenerateUniqueNumber"
	Generator_GenerateUniqueString_FullMethodName = "/Generator/GenerateUniqueString"
)
...
func (c *generatorClient) GenerateUniqueNumber(ctx context.Context, in *GenerateUniqueNumberRequest, opts ...grpc.CallOption) (*GenerateUniqueNumberResponse, error) {
	...
	err := c.cc.Invoke(ctx, Generator_GenerateUniqueNumber_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *generatorClient) GenerateUniqueString(ctx context.Context, in *GenerateUniqueStringRequest, opts ...grpc.CallOption) (*GenerateUniqueStringResponse, error) {
	...
	err := c.cc.Invoke(ctx, Generator_GenerateUniqueString_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Generator_GenerateUniqueNumber_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Generator_GenerateUniqueNumber_FullMethodName,
	}
...
func _Generator_GenerateUniqueString_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Generator_GenerateUniqueString_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
