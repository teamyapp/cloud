...
var storageSet = wire.NewSet(wire.Bind(new(storage.ObjectStore), new(*storage.S3Bucket)), wire.Bind(new(storage.ObjectStoreRequestHandlers), new(*storage.S3Bucket)), newS3Bucket)
